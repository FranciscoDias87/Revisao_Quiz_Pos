...
export const quizQuestions: Question[] = [
  // MÓDULO 1: Paradigmas da Avaliação (IDs 1-50)
  {
    ...
    options: [
      "Influências exclusivas da revolução industrial recente.",
      "Bagagens históricas de herança colonialista e cultura dualista.",
  ...
  },
  {
    ...
    options: [
      "O desenvolvimento da educação laica e emancipatória.",
      "A implementação de um currículo por competências.",
  ...
  },
  {
    ...
    options: [
      "Nossas bases culturais patriarcais e patrimonialistas.",
      "Um modelo escolar perfeitamente equitativo.",
  ...
  },
  {
    ...
    options: [
      ...
      "Plena gestão democrática desde o período imperial.",
  ...
  },
  {
    ...
    options: [
      "Retornar aos métodos da educação jesuítica.",
      "Punir os docentes pelo insucesso escolar.",
  ...
  },
  {
    ...
    options: [
      "Homogênea para todas as classes sociais.",
      "Dualista, refletindo divisões de classe.",
      "Independente dos modos de produção do mundo do trabalho.",
      "Integralmente construtivista."
    ],
    correctAnswer: 1
  },
  {
    ...
    options: [
      "Formar mão de obra hiper-especializada para fábricas.",
      "Promover a leitura e a escrita restrita associada ao ensino religioso.",
      "Impulsionar a pesquisa acadêmica de base.",
      "Inserir o país nas avaliações internacionais."
    ],
    correctAnswer: 1
  },
  {
    ...
    options: [
      "Educação tecnicista e voltada apenas ao mercado.",
      "Reprodução da bagagem patriarcal.",
      "Educação integral e popular.",
      "Expansão do ensino jesuítico no século XXI."
    ],
    correctAnswer: 2
  },
  {
    ...
    options: [
      "Uma ferramenta neutra de transmissão de saberes.",
      "Apenas o conjunto de apostilas do sistema de ensino.",
      "Um conceito amplo que envolve normatizações prescritivas e relações de poder.",
      "Um reflexo exato e inquestionável do conhecimento universal."
    ],
    correctAnswer: 2
  },
  {
    ...
    options: [
      "Ele abrange toda a cultura humana existente, sem exceções.",
      "Pressupõe a escolha de determinados saberes e o silenciamento de outros.",
      "É construído unicamente pelos discentes.",
      "Não possui relação com disputas macropolíticas."
    ],
    correctAnswer: 1
  },
  {
  ...
  },
  {
    ...
    options: [
      "O currículo imediatamente se tornasse integral.",
      "A educação fosse privatizada em sua totalidade.",
      "Modelos curriculares começassem a sofrer novas influências, moldando a configuração escolar tardiamente.",
      "A especialização do trabalho fosse banida das escolas."
    ],
    correctAnswer: 2
  },
  {
    ...
    options: [
      "Elementos práticos da vivência social e de reprodução cultural.",
      "Apenas as atas de reuniões escolares.",
      "O rendimento bruto do PIB brasileiro.",
      "O quantitativo de horas destinadas ao recreio de forma isolada."
    ],
    correctAnswer: 0
  },
  {
    ...
    options: [
      "Expressão de disputas na macropolítica nacional e global.",
      "Um arquivo morto após a criação da LDB.",
      "Exclusividade da gestão de empresas privadas.",
      "Uma pauta restrita à educação infantil."
    ],
    correctAnswer: 0
  },
  {
  ...
  },
  {
    ...
    options: [
      "Demandas estritamente comunistas.",
      "Lutas populares organizadas e uma necessidade liberal de moldar o trabalhador urbano.",
      "Exigências de agências multilaterais do século XIX.",
      "Uma visão anarquista da educação."
    ],
    correctAnswer: 1
  },
  {
    ...
    options: [
      "Opressora, capitalista e mercantil.",
      "Diagnóstica, formativa, construtivista e emancipatória.",
      "Punitiva, seletiva, dualista e ortodoxa.",
      "Tradicional, jesuítica, bancária e excludente."
    ],
    correctAnswer: 1
  },
  {
    ...
    options: [
      ...
      "O fim do princípio de cidadania.",
  ...
  },
  {
    ...
    options: [
      "O ócio excessivo na zona rural.",
      "Condições degradantes de trabalho infantil na revolução industrial nascente.",
      "Excesso de avaliações em larga escala.",
      "Um sistema de saúde escolar compulsório e rigoroso."
    ],
    correctAnswer: 1
  },
  {
  ...
  },
  {
    ...
    options: [
      "Máxima, visando o fim das classes sociais.",
      "Mínima, mantendo a ordem do mercado.",
      "Estritamente focada na nobreza.",
      "Que repudiava o conceito de 'ser humano civilizado'."
    ],
    correctAnswer: 1
  },
  {
    ...
    options: [
      "Classificar os alunos entre aptos e inaptos ao trabalho industrial.",
      "Fornecer elementos que contribuam para a melhoria da aprendizagem do aluno e da qualidade educacional.",
      "Punir o docente que não cumpre as normativas prescritivas.",
      "Atender somente às metas do Banco Mundial."
    ],
    correctAnswer: 1
  },
  {
    ...
    options: [
      "É transferido de forma unilateral do professor para o aluno.",
      "É uma construção contínua do sujeito em interação com o meio.",
      "Deve ser medido exclusivamente por provas finais de múltipla escolha.",
      "É inato e não depende do ensino formal."
    ],
    correctAnswer: 1
  },
  {
    ...
    options: [
      "É um conceito estático e universal.",
      "Passa pelo aprimoramento do direito à igualdade e à diferença.",
      "Ignora por completo os fatores socioeconômicos dos alunos.",
      "Se resume à adoção de tecnologias digitais."
    ],
    correctAnswer: 1
  },
  {
    ...
    options: [
      "Mudanças e crises no mundo e na esfera produtiva (mercado de trabalho) no século XXI.",
      "Um resgate das teses jesuíticas do século XVI.",
      "Pedidos unânimes de sindicatos de professores do Brasil.",
      "Uma busca pelo fim das avaliações em larga escala."
    ],
    correctAnswer: 0
  },
  {
    ...
    options: [
      "Serem apenas observadores passivos da educação brasileira.",
      "Orientar e estruturar reformas educacionais e currículos nacionais.",
      "Combater ativamente o ensino voltado para competências.",
      "Promover o modelo de educação clássica greco-romana."
    ],
    correctAnswer: 1
  },
  {
    ...
    options: [
      "Interesses exclusivos dos municípios menores.",
      "Agências multilaterais e demandas do mercado de trabalho.",
      "Movimentos sociais e estudantis.",
      "Instituições de filantropia religiosa."
    ],
    correctAnswer: 1
  },
  {
    ...
    options: [
      ...
      "Adequar-se a um quadro de empregabilidade incerto e em constante mutação.",
      "Dominar apenas o currículo clássico de latim e filosofia.",
      "Recusar avaliações padronizadas."
    ],
    correctAnswer: 1
  },
  {
    ...
    options: [
      "Apenas a formatação do boletim escolar.",
      "A concepção de gestão da aprendizagem, o trabalho docente e a discência.",
      "Unicamente a compra de merenda escolar.",
      "A redução do tempo de escolarização obrigatória."
    ],
    correctAnswer: 1
  },
  {
    ...
    options: [
      "Pesquisadores estritamente locais.",
      "Organizações internacionais e exigências geopolíticas/econômicas.",
      "Uma recusa formal ao modelo do PISA.",
      "Diretrizes do Império Brasileiro não revogadas."
    ],
    correctAnswer: 1
  },
  {
    ...
    options: [
      ...
      "A subordinação às macropolíticas de adequação da educação ao trabalho flexível.",
      "O fortalecimento radical da autonomia financeira das escolas.",
      "O abandono do currículo nacional em prol de currículos individuais."
    ],
    correctAnswer: 1
  },
  {
    ...
    options: [
      ...
      "Garantia de estabilidade e emprego vitalício a todos os egressos.",
      "Fortalecimento das abordagens críticas em detrimento do pragmatismo."
    ],
    correctAnswer: 1
  },
  {
    ...
    options: [
      "Autonomia absoluta do professor em sala.",
      "Comprovação da eficiência da aprendizagem nos sistemas educacionais.",
      "Supressão total das notas na educação básica.",
      "Valorização exclusiva das disciplinas artísticas."
    ],
    correctAnswer: 1
  },
  {
    ...
    options: [
      ...
      "A Prova Brasil em 2005.",
      "O Projeto Edurural (1987), coordenado pela Fundação Carlos Chagas.",
  ...
  },
  {
    ...
    options: [
      "Vestibular tradicional brasileiro.",
      "Programa Internacional de Avaliação de Estudantes (PISA).",
      "Exame supletivo.",
      "Modelo educacional da extinta União Soviética."
    ],
    correctAnswer: 1
  },
  {
    ...
    options: [
      "Merenda escolar, infraestrutura da escola e condição socioeconômica das famílias.",
      "Apenas a vontade pessoal e vocação inata do estudante.",
      "Exclusivamente a carga horária de matemática.",
      "A quantidade de reuniões pedagógicas no ano letivo."
    ],
    correctAnswer: 0
  },
  {
  ...
  },
  {
    ...
    options: [
      "Variáveis geográficas relacionadas ao fuso horário.",
      "Condições socioeconômicas dos estudantes e o nível de industrialização da região.",
      "Crenças religiosas dos professores aplicadores da prova.",
      "Fases da lua no momento da aplicação do teste."
    ],
    correctAnswer: 1
  },
  {
    ...
    options: [
      "Competências e habilidades essenciais para a leitura, matemática e ciências.",
      "Capacidade de memorização de datas históricas.",
      "Desempenho físico-motor dos alunos.",
      "Conhecimento exclusivo sobre a história nacional profunda."
    ],
    correctAnswer: 0
  },
  {
    ...
    options: [
      "Currículo de base comum organizado por competências.",
      "Ensino estritamente confessional em todas as redes.",
      "Fim do ensino médio como etapa da educação básica.",
      "Modelo de avaliação sem qualquer padrão métrico."
    ],
    correctAnswer: 0
  },
  {
    ...
    options: [
      "Um retrocesso à era colonial pré-jesuítica.",
      "Um cenário de reforma flexibilizadora que atende lógicas gerencialistas de mercado.",
      "O aumento do tempo integral presencial para 100% dos alunos.",
      "A falência definitiva do Sistema SAEB."
    ],
    correctAnswer: 1
  },
  {
    ...
    options: [
      "Algo terciário e terceirizado para agências externas.",
      "Parte integral dos períodos dedicados ao planejamento e desenvolvimento profissional.",
      "Uma obrigação meramente burocrática ao final de cada bimestre, sem peso pedagógico.",
      "Exclusividade dos coordenadores e diretores."
    ],
    correctAnswer: 1
  },
  {
    ...
    options: [
      "Gestão autoritária e vertical.",
      "Gestão democrática, com participação dos profissionais na elaboração do projeto pedagógico.",
      "Gestão terceirizada para Organizações Sociais.",
      "Gestão militarizada em todas as instâncias."
    ],
    correctAnswer: 1
  },
  {
    ...
    options: [
      "É a principal solução para a elevação dos índices de proficiência.",
      "Reflete muitas vezes processos amplos de exclusão que precisam ser superados com abordagens inclusivas.",
      "Foi formalmente proibida e extinta pela legislação.",
      "Ocorre por culpa exclusiva da indisciplina discente."
    ],
    correctAnswer: 1
  },
  {
    ...
    options: [
      "Um trabalho mecânico de repetição de manuais prescritos.",
      "Um serviço de assistência social desvinculado do conhecimento.",
      "Um trabalho intelectual que demanda autorreflexão contínua no cotidiano escolar.",
      "Uma atividade que prescinde de planejamento acadêmico."
    ],
    correctAnswer: 2
  },
  {
    ...
    options: [
      "Um elemento dispensável frente a currículos centralizados.",
      "Proibida pelas novas regras do SAEB.",
      "Um elemento indispensável para o real cumprimento dos preceitos da LDB.",
      "Limitada apenas às disciplinas da base diversificada."
    ],
    correctAnswer: 2
  },
  {
    ...
    options: [
      "Incapacidade inata dos estudantes de classes populares.",
      "Concepção formativa e do projeto pedagógico adotado pela instituição escolar.",
      "Exclusiva vontade política do governo federal vigente.",
      "Imposição direta das editoras de livros didáticos."
    ],
    correctAnswer: 1
  },
  {
    ...
    options: [
      "Exclusivamente somativa.",
      "Classificatória e restritiva.",
      "Punitiva para alunos de baixo rendimento.",
      "Formativa, auxiliando o professor a replanejar suas rotas de ensino."
    ],
    correctAnswer: 3
  },
  {
    ...
    options: [
      "Reforçam perfeitamente todos os ideais democráticos originais da LDB.",
